...
const closeBigPicBtn = document.querySelector('.picture-big__button-close');
...
function PopupOpenClose(elem) {//открытие и закрытие всех форм
...
function formSubmitHandler(evt) {
    ...
    PopupOpenClose(popupInformation);
...
function formSubmitPictureAdd(evt) {//добавляем картинку и название из данных формы
    ...
    PopupOpenClose(popupPictureAdd);//закрыли форму добавления картинки
}
...
function showPictureBig(evt) {//добавляем поп-ап увеличения той картинки, на которую мы нажали
    ...
    PopupOpenClose(popupPictureBig);
}
//кнопка плюса, листенеры на кнопку открытия и на крестик закрытия
plus.addEventListener('click', () => PopupOpenClose(popupPictureAdd));
closePic.addEventListener('click', () => PopupOpenClose(popupPictureAdd));

//кнопка карандаш, листенеры на кнопку открытия и на крестик закрытия
button.addEventListener('click', () => PopupOpenClose(popupInformation));
close.addEventListener('click', () => PopupOpenClose(popupInformation));
closeBigPicBtn.addEventListener('click', () => PopupOpenClose(popupPictureBig));
